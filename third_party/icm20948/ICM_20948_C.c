...
// Zephyr/nRF 直接从只读 Flash 访问固件。必须先于 __arm__ 分支判断，
// 否则 ARM 编译器会被误判为需要 AVR PROGMEM。
...
#if defined(__ZEPHYR__)
_Static_assert(sizeof(dmp3_image) == DMP_CODE_SIZE,
               "ICM-20948 DMP firmware size mismatch");
#endif
#endif
